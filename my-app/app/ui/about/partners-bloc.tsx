...
export default function PartnersBloc() {
    return (
        <div className="text-xl text-slate-600 dark:bg-slate-800">
            
            <h2 className='w-2/5 m-auto text-3xl font-bold text-center
                text-transparent bg-clip-text 
                dark:bg-gradient-to-r dark:from-indigo-500 dark:from-10% 
                dark:via-blue-500 dark:via-50% dark:to-emerald-500 dark:to-90%
            ...
            <div className='flex align-center justify-evenly mt-10 mb-10'>
                ...
                <legend className="text-indigo-500 dark:text-sky-500 mt-2">NextJS</legend>
                </div>

                <div className='text-center w-[100px] h-auto m-auto'>
                <Image src={nextAuth} width={60} height={80} alt="img nextAuth logo" 
                    className='object-cover m-auto' />
                <legend className="text-indigo-500 dark:text-sky-500 mt-2">NextAuth</legend>
                </div>
                ...
                <legend className="text-indigo-500 dark:text-sky-500 mt-2">React</legend>
                </div>
            ...
            <div className='flex justify-evenly mb-10'>
                ...
                <Image src={mySql} width={100} height={100} alt="img mysql logo" 
                    className='object-cover bg-slate-100 -mt-4 rounded-full' />
                <legend className="text-indigo-500 dark:text-sky-500 mt-2">MySQL</legend>
                </div>

                <div className='text-center w-[80px] h-auto my-auto'>
                <Image src={tailWind} width={100} height={100} alt="img tailwind logo" 
                    className='object-cover' />
                <legend className="text-indigo-500 dark:text-sky-500 mt-4">Tailwind</legend>
                </div>
